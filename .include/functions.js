...
function markObjects(dbData) {
	for (i in dbData) {
		document.write('<div id="'+i+'" class="mark" style="'+getTopLeft(server_map, dbData[i][1], dbData[i][0], i)+'z-index:'+dbData[i][4]+';" oncontextmenu="thisHide(this,box_hide_delay);return false;"><b>'+dbData[i][0]+'</b> ['+i+']<br>Owner: <b>'+dbData[i][2]+'</b> ['+dbData[i][5]+']<br>'+dbData[i][3]+'</div>');
	}
}
