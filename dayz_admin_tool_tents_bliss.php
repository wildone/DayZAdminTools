...
<html>
	...
	<body onload="JavaScript:timedRefresh(31000);">
		<input id="back" type="button" onclick="document.location.href='index.html';" value="Index"><input id="refresh" type="text" value="" readonly><input id="tents" type="button" onclick="document.location.href='?opt=0';" value="Tents"><input type="button" onclick="document.location.href='?opt=1';" value="Inventory"><input type="button" onclick="document.location.href='?opt=2';" value="Position">
